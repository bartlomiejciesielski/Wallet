...
const createNewTransaction = () => {
	...
	moneyArr.push(parseFloat(amountInput.value)) //parseFloat zamienia typ string na number
	countMoney(moneyArr)
	closePanel()
	ID++
	clearInputs()
...
const selectCategory = () => {
	selectedCategory = categorySelect.options[categorySelect.selectedIndex].text // kod pozwala na uzyskanie tekstu wybranej kategorii (opcji) z rozwijanej listy o nazwie categorySelect i przypisuje ten tekst do zmiennej selectedCategory. Możesz użyć tej zmiennej dalej w skrypcie do wykonywania różnych działań na wybranej kategorii.
}
...
const changeStyleToLight = () => {
    root.style.setProperty('--first-color', '#ddd')
...
const changeStyleToDark = () => {
    ...
    root.style.setProperty('--second-color', '#ddd')
...
colorLightBtn.addEventListener('click', changeStyleToLight)
colorDarkBtn.addEventListener('click', changeStyleToDark)